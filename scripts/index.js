window.onload=function(){
    ...
    var fn=function(){
        ...
        for(var i=0;i<7;i++){
            for(var j=0;j<i+1;j++){
                ...
                block.style.left=(7-i)*140/2+j*140+'px';
        ...
        blockb.style.top=450+'px';
        blockb.style.left=290+'px';
        ...
        blockc.style.top=450+'px';
        blockc.style.left=620+'px';
    ...
    show.onclick=function(e){
        ...
        el.style.webkitTransform='scale(1.06)'; 
        pervious=el; 
